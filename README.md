...
- [一、标题](#一标题)
  ...
  - [1.3 使用HTML标签](#13-使用html标签)
  - [1.4 目录生成](#14-目录生成)
    - [1.4.1 TOC语法](#141-toc语法)
    - [1.4.2 制作目录](#142-制作目录)
    - [1.4.3 使用插件制作目录](#143-使用插件制作目录)
- [二、文本格式](#二文本格式)
  - [2.1 换行](#21-换行)
  - [2.2 字体格式](#22-字体格式)
    - [2.2.1 Markdown中的粗体、斜体以及组合](#221-markdown中的粗体斜体以及组合)
    - [2.2.2 HTML中的粗体、斜体以及组合](#222-html中的粗体斜体以及组合)
...
| 5    | 删除线             | 1、使用两个波浪号`~~`包围；                                  | 1、使用`<del>`标签；<br />2、使用`<s>`标签；                 | 1、使用`\cancel{}`命令；                                 | • 支持Markdown<br />• 支持HTML<br />• 支持Latex公式     | • 支持Markdown<br />• 支持HTML<br />• 支持Latex公式     |
