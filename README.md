...
- [八、GitHub常见组件](docs/08-github-features.md)
	...
	- [8.8 GitHub自动引用与提及](docs/08-github-features.md#88-github-自动引用与提及)
		- [8.8.1 Issue和Pull Request引用](docs/08-github-features.md#881-issue-和-pull-request-引用)
		- [8.8.2 Commit引用](docs/08-github-features.md#882-commit-引用)
		- [8.8.3 用户和团队提及](docs/08-github-features.md#883-用户和团队提及)
